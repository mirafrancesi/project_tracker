...
def get_project_by_title(title):
    ...
    row = db_cursor.fetchone()
    print "Project Title: {}\nProject Description: {}".format(row[0], row[1])
...
def get_grade_by_github_title(github, title):
    ...
    row = db_cursor.fetchone()
    print "The grade for this project was {}.".format(row[0])
...
def assign_grade(github, title, grade):
    ...
    db.session.commit()
    print 'Successfully added {} for student {} for {} project.'.format(grade, github, title)
